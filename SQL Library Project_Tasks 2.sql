...
-- 6. Create Summary Tables: Usd CTAS to generate new tables based on query results - each book and total book_issued_cnt
SELECT 
    b.isbn, 
    b.book_title, 
...
-- Write a query to identify members who have overdue books (assume a 180-day return period). Display the member's_id, member's name, book title, issue date, and days overdue.
