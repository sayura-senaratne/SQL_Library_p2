...
VALUES
('B001', 'E109', '123 Main St', '+13125550173'),
('B002', 'E109', '456 Elm St', '+16465550125'),
('B003', 'E109', '789 Oak St', '+14155550198'),
('B004', 'E110', '567 Pine St', '+12025550144'),
('B005', 'E110', '890 Maple St', '+17185550162');
...
) AS v(return_id, issued_id, return_date)
WHERE issued_id IN (SELECT issued_id FROM issued_status);

SELECT * FROM return_status;

SELECT DISTINCT r.issued_id
